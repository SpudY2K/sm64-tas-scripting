...
extern struct Animation animList[];
...
s32 stationary_ground_step(struct MarioState*, struct Surfaces* surfaceLists);
s32 perform_ground_step(struct MarioState*, struct Surfaces* surfaceLists);
s32 perform_air_step(struct MarioState*, struct Surfaces* surfaceLists, u32);
