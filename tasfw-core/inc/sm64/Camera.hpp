...
struct CameraData {
    ...
    struct PlayerCameraState* sLuigiCamState;
};
...
s32 cam_select_alt_mode(struct CameraData* cameraData, s32 angle);
...
s16 next_lakitu_state(struct CameraData* cameraData, struct Surfaces* surfaceLists, Vec3f newPos, Vec3f newFoc, Vec3f curPos, Vec3f curFoc, Vec3f oldPos, Vec3f oldFoc, s16 yaw);
