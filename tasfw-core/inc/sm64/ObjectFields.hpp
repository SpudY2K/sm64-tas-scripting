...
/* Common fields */
	...
	// 0x0F4-0x110 (0x1B-0x22) are object specific and defined below the common
	// fields.
	...
	#define /*0x138*/ oParentRelativePosX \
		OBJECT_FIELD_F32(O_PARENT_RELATIVE_POS_INDEX + 0)
	#define /*0x13C*/ oParentRelativePosY \
		OBJECT_FIELD_F32(O_PARENT_RELATIVE_POS_INDEX + 1)
	#define /*0x140*/ oParentRelativePosZ \
		OBJECT_FIELD_F32(O_PARENT_RELATIVE_POS_INDEX + 2)
	...
	// 0x1AC-0x1B2 (0x48-0x4A) are object specific and defined below the common
	// fields.
	...
	#define /*0x104*/ oActivatedBackAndForthPlatformStartYaw \
		OBJECT_FIELD_S32(0x1F)
	#define /*0x108*/ oActivatedBackAndForthPlatformVertical \
		OBJECT_FIELD_S32(0x20)
	#define /*0x10C*/ oActivatedBackAndForthPlatformFlipRotation \
		OBJECT_FIELD_S32(0x21)
	...
	#define /*0x108*/ oBowserPuzzlePieceContinuePerformingAction \
		OBJECT_FIELD_S32(0x20)
	...
	#define /*0x0F8*/ oChainChompMaxDistFromPivotPerChainPart \
	...
	#define /*0x0F8*/ oCheckerBoardPlatformUnkF8 \
		OBJECT_FIELD_S32(0x1C)	// oAction like
...
// 0x1D-0x21 reserved for pathing
	...
	#define /*0x0F8*/ oFirePiranhaPlantScale \
		OBJECT_FIELD_F32(0x1C)	// Shared with above obj? Coincidence?
	...
	#define /*0x0F4*/ oPlatformOnTrackDistMovedSinceLastBall \
		OBJECT_FIELD_F32(0x1B)
	...
	/* Pokey Body Part */
	#define /*0x0F8*/ oPokeyBodyPartDeathDelayAfterHeadKilled \
		OBJECT_FIELD_S32(0x1C)
